...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-------+-------+-------+-------+-------+  -------+-------+-------+-------+-------.
     KC_RST ,XXXXXXX,XXXXXXX,XXXXXXX,KC_RMOD,  KC_RHUI,KC_RSAI,KC_RVAI,KC_RTOG,_______,
     KC_L1  ,KC_L2  ,XXXXXXX,XXXXXXX,KC_RRMD,  KC_RHUD,KC_RSAD,KC_RVAD,KC_DBUG,_______,
